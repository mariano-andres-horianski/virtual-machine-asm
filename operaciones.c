...
void funcion_ADD(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
...
void funcion_SUB(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = get(Tipo1,registros[OP1],registros,memoria) - get(Tipo2,registros[OP2],registros,memoria);
    actualizarCC(registros,resultado);
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos);
}
void funcion_MUL(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = get(Tipo1,registros[OP1],registros,memoria) * get(Tipo2,registros[OP2],registros,memoria);
    actualizarCC(registros,resultado); 
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos); 
}
void funcion_DIV(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
...
void funcion_CMP(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = get(Tipo1,registros[OP1],registros,memoria) - get(Tipo2,registros[OP2],registros,memoria);
    actualizarCC(registros,resultado);
}
void funcion_SHL(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
...
void funcion_SHR(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = (get(Tipo1,registros[OP1],registros,memoria) >> get(Tipo2,registros[OP2],registros,memoria)) & ~(0x1 >> get(Tipo2,registros[OP2],registros,memoria));  // ???
    actualizarCC(registros,resultado);
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos);
}
void funcion_SAR(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
...
void funcion_AND(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = get(Tipo1,registros[OP1],registros,memoria) & get(Tipo2,registros[OP2],registros,memoria);
    actualizarCC(registros,resultado);
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos);
}
void funcion_OR(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = get(Tipo1,registros[OP1],registros,memoria) | get(Tipo2,registros[OP2],registros,memoria);
    actualizarCC(registros,resultado);
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos);
}
void funcion_XOR(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = get(Tipo1,registros[OP1],registros,memoria) ^ get(Tipo2,registros[OP2],registros,memoria);
    actualizarCC(registros,resultado);
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos);
}
void funcion_SWAP(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
...
void funcion_LDL(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = (get(Tipo2,registros[OP2],registros,memoria) & 0x0000FFFF) | (get(Tipo1,registros[OP1],registros,memoria) & 0xFFFF0000);
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos);
}
void funcion_LDH(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = ((get(Tipo2,registros[OP2],registros,memoria) << 16) & 0xFFFF0000) | (get(Tipo1,registros[OP1],registros,memoria) & 0x0000FFFF);
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos);
}
void funcion_NOT(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
    int resultado;
    resultado = ~get(Tipo1,registros[OP1],registros,memoria);
    ResultadoOperacion(Tipo1,registros,memoria,resultado,tablaSegmentos);
}
void funcion_STOP(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
...
.
*/
void funcion_NO_ACCESIBLE(uint8_t Tipo1,uint8_t Tipo2,uint32_t registros[],uint8_t memoria[],infoSegmento tablaSegmentos[]){
